...
Configuring this provider is simple with AuthenticationManagerBuilder:
    ...
    // Step 1
    @Autowired
    private AuthEntryPointExceptionHandler authEntryPointExceptionHandler;
...
When a HTTP request comes (from a browser, a web service client, an HttpInvoker or an AJAX application – Spring doesn’t care),
